...
npx wrangler d1 execute "$DB_NAME" --command="DROP TABLE IF EXISTS winix_auth_state; DROP TABLE IF EXISTS winix_control_state; DROP TABLE IF EXISTS samples_hourly; DROP TABLE IF EXISTS samples_raw; DROP TABLE IF EXISTS devices; DROP TABLE IF EXISTS _cf_KV; DROP TABLE IF EXISTS d1_migrations;" >/dev/null
